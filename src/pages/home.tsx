...
export function Home() {
  return (
    <main className="bg-white text-gray-900 min-h-screen pt-20 flex flex-col">
      ...
      >
        <div className="flex-1 max-w-xl text-center md:text-left">
          <h1 className="text-5xl md:text-6xl font-extrabold leading-tight text-green-800 mb-6 tracking-tight">
            Domine o Inglês com <br /> <span className=" text-green-800">Leonardo Campos</span>
          </h1>
        ...
        <motion.div
          ...
          className="flex-1 max-w-md rounded-3xl overflow-hidden shadow-2xl ring-1 ring-green-800/10 relative"
        >
      ...
      <section className="bg-gray-50 py-20">
        ...
        >
          <h2 className="text-4xl font-bold text-green-800 border-b-4 border-green-800 inline-block pb-3 mb-12">
